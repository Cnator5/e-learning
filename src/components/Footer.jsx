  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-12">
      ...
      <div>
        ...
        <ul className="text-gray-400 space-y-2">
          <li>Email: <a href="cnator:info@gmail.com" className="hover:text-indigo-400">info@cnator.com</a></li>
          <li>Phone: <a href="tel:+237 681 326 315" className="hover:text-indigo-400">+ (237) 681 326 315</a></li>
